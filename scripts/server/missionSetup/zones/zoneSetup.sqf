// ***TO DO!!!: What happens if a point is overlapped by two zones?

/* Mission setup function responsible for turning zone markers and zone related data into array and variable form, generating 
paths from them (for use by the AI) and then saving that information into an external databse for using when the mission is 
running. 
...
#define IDEAL_SEGMENT_SIZE 1000
...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
/* Function will index sort and place zones in kyf_WG_allZones based on their name. So "kyf_zone0" will be at index 0 while "kyf_zone2" will be at index 2. 
...
// Note that zone division and segmentation only occur for land zones
